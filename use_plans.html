...
<head>
    ...
    <script type="text/javascript"
        src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=bB8H5rgknsMqiKIDV0ALeuocIbXd6Uro&amp;services=&amp;t=20171004185957"></script>
...
<body>
    ...
    <header>
        <div class="main">
            ...
            <nav>
                <ul class="menu">
                    <li class="current"><a href="plans_use.html">线路查看</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <section id="content" class="border subpage-content">
        ...
        <div class="container_12">
            ...
            <div class="grid_4">
                <p><a href="use_route1.html" class="color-1 font-1">路线1</a></p>


            </div>
            <div class="grid_4">
                <p><a href="#" class="color-1 font-1">路线2</a></p>


            </div>
            <div class="grid_4">
                <p><a href="#" class="color-1 font-1">路线3</a></p>
            ...
            <script>
                ...
                var point = new BMap.Point(114.067861, 22.656933);
