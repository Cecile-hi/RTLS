!function(t, e) {
    ...
    i.exports), a = (o.getSerialize,
    "undefined" != typeof window ? window : void 0 !== n ? n : "undefined" != typeof self ? self : {});
    function s(t) {
        return void 0 === t
    }
    function l(t) {
    ...
    function g(t) {
        for (var e, r = [], n = 0, i = t.length; n < i; n++)
            c(e = t[n]) ? r.push(e.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1")) : e && e.source && r.push(e.source);
    ...
    function S(t) {
        if ("string" == typeof t)
            return t.length <= 40 ? t : t.substr(0, 39) + "…";
    ...
    var k = {
        ...
        htmlTreeAsString: function(t) {
            for (var e, r = [], n = 0, i = 0, o = " > ".length; t && n++ < 5 && !("html" === (e = v(t)) || n > 1 && i + r.length * o + e.length >= 80); )
                r.push(e),
                i += e.length,
                t = t.parentNode;
        ...
        isSameException: function(t, e) {
            return !_(t, e) && (t = t.values[0],
            e = e.values[0],
            t.type === e.type && t.value === e.value && (r = t.stacktrace,
            n = e.stacktrace,
            (!s(r) || !s(n)) && m(t.stacktrace, e.stacktrace)));
            var r, n
        },
        isSameStacktrace: m,
        parseUrl: function(t) {
    ...
    w.report = function() {
        var t, e, r = [], n = null, i = null, o = null;
        function a(t, e) {
            var n = null;
        ...
        function s(e, r, n, i, s) {
            ...
            if (o)
                w.computeStackTrace.augmentStackTraceWithInitialElement(o, r, n, u),
                l();
            else if (c && k.isError(c))
                a(w.computeStackTrace(c), !0);
            else {
                var f, h = {
                    url: r,
                    line: n,
            ...
            if (void 0 !== t.stack && t.stack) {
                ...
                0), h = c.length; f < h; ++f) {
                    if (r = i.exec(c[f])) {
                        ...
                        if (!(r = a.exec(c[f])))
                            continue;
                        r[3] && r[3].indexOf(" > eval") > -1 && (e = s.exec(r[3])) ? (r[3] = e[1],
                        r[4] = e[2],
                        r[5] = null) : 0 !== f || r[5] || void 0 === t.columnNumber || (u[0].column = t.columnNumber + 1),
                        n = {
                            url: r[3],
                            func: r[1] || R,
                            args: r[2] ? r[2].split(",") : [],
      ...
      , X = function(t, e, r) {
        ...
        if (e in t) {
            ...
            t[e] = function() {
                ...
                "assert" === e ? !1 === t[0] && (a = "Assertion failed: " + (k.safeJoin(t.slice(1), " ") || "console.assert"),
    ...
    function Tt() {
        ...
        this._hasDocument = !Q(Ct),
        this._hasNavigator = !Q(Rt),
        ...
        this._originalConsole = Ot.console || {},
    ...
    Tt.prototype = {
        ...
        wrap: function(t, e, r) {
            ...
            function i() {
                var i = []
                  , o = arguments.length
                  , a = !t || t && !1 !== t.deep;
                for (r && tt(r) && r.apply(this, arguments); o--; )
                    i[o] = a ? n.wrap(t, arguments[o]) : arguments[o];
                try {
        ...
        captureException: function(t, e) {
            ...
            Z(t) && t.error)
                ...
                if (!Y(t))
                    return this.captureMessage(t, ot(e, {
                        stacktrace: !0,
        ...
        showReportDialog: function(t) {
            if (Ct) {
                ...
                if (!e)
                    throw new $("Missing eventId");
                var r = t.dsn || this._dsn;
                if (!r)
                    throw new $("Missing DSN");
        ...
        _triggerEvent: function(t, e) {
            ...
            if (this._hasDocument) {
                ...
                Ct.createEvent ? (r = Ct.createEvent("HTMLEvents")).initEvent(t, !0, !0) : (r = Ct.createEventObject()).eventType = t,
                e)
                    lt(e, n) && (r[n] = e[n]);
                if (Ct.createEvent)
                    Ct.dispatchEvent(r);
        ...
        _instrumentTryCatch: function() {
            ...
            function i(r) {
                ...
                i && i.hasOwnProperty && i.hasOwnProperty("addEventListener") && (vt(i, "addEventListener", function(e) {
                    return function(i, o, a, s) {
                        try {
                            o && o.handleEvent && (o.handleEvent = t.wrap(o.handleEvent))
                        } catch (t) {}
                        var l, c, u;
                        return n && n.dom && ("EventTarget" === r || "Node" === r) && (c = t._breadcrumbEventHandler("click"),
                ...
                vt(i, "removeEventListener", function(t) {
            ...
            Ot.requestAnimationFrame && vt(Ot, "requestAnimationFrame", function(e) {
                return function(r) {
                    return e(t.wrap(r))
                }
            }, e);
        ...
        _instrumentBreadcrumbs: function() {
                ...
                vt(i, "send", function(e) {
                    return function() {
                        ...
                        for (var o = ["onload", "onerror", "onprogress"], a = 0; a < o.length; a++)
                            n(o[a], r);
                        return "onreadystatechange"in r && tt(r.onreadystatechange) ? vt(r, "onreadystatechange", function(e) {
            ...
            e.xhr && _t() && vt(Ot, "fetch", function(e) {
                return function() {
                    for (var r = new Array(arguments.length), n = 0; n < r.length; ++n)
                        r[n] = arguments[n];
                    var i, o = r[0], a = "GET";
                    if ("string" == typeof o ? i = o : "Request"in Ot && o instanceof Ot.Request ? (i = o.url,
            ...
            e.dom && this._hasDocument && (Ct.addEventListener ? (Ct.addEventListener("click", t._breadcrumbEventHandler("click"), !1),
            Ct.addEventListener("keypress", t._keypressEventHandler(), !1)) : (Ct.attachEvent("onclick", t._breadcrumbEventHandler("click")),
            Ct.attachEvent("onkeypress", t._keypressEventHandler())));
            var o = Ot.chrome
            ...
            if (e.console && "console"in Ot && console.log) {
                ...
                it(["debug", "info", "warn", "error", "log"], function(t, e) {
                    xt(console, e, c)
                })
            }
        },
        ...
        _parseDSN: function(t) {
            ...
            if (r.pass && !this._globalOptions.allowSecretKey)
                throw new $("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key");
            return r
        },
        ...
        _processException: function(t, e, r, n, i, o) {
            var a, s = (t ? t + ": " : "") + (e || "");
            if ((!this._globalOptions.ignoreErrors.test || !this._globalOptions.ignoreErrors.test(e) && !this._globalOptions.ignoreErrors.test(s)) && (i && i.length ? (r = i[0].filename || r,
            i.reverse(),
            a = {
                frames: i
            }) : r && (a = {
        ...
        _trimPacket: function(t) {
            ...
            if (t.message && (t.message = at(t.message, e)),
            t.exception) {
                var r = t.exception.values[0];
                r.value = at(r.value, e)
            }
            var n = t.request;
            return n && (n.url && (n.url = at(n.url, this._globalOptions.maxUrlLength)),
            n.Referer && (n.Referer = at(n.Referer, this._globalOptions.maxUrlLength))),
        ...
        _getHttpData: function() {
            if (this._hasNavigator || this._hasDocument) {
                ...
                this._hasDocument && Ct.referrer && (t.headers || (t.headers = {}),
                t.headers.Referer = Ct.referrer),
                t
            }
        },
        ...
        _send: function(t) {
            ...
            (t = ot(r, t)).tags = ot(ot({}, this._globalContext.tags), t.tags),
            t.extra = ot(ot({}, this._globalContext.extra), t.extra),
        ...
        _mergeContext: function(t, e) {
            Q(e) ? delete this._globalContext[t] : this._globalContext[t] = ot(this._globalContext[t] || {}, e)
        }
    },
    ...
    function() {
        if (["https:", "http:"].indexOf(window.location.protocol) >= 0 && !((t = window).callPhantom || t._phantom || t.__phantomas || t.buffer || t.Buffer || t.emit || t.spawn || t.webdriver || t.domAutomation || t.domAutomationController)) {
            var t, n = (document.currentScript ? document.currentScript : document.querySelector("script[data-sentry-config]")).dataset.sentryConfig, i = n && JSON.parse(n);
            if (i) {
                var o = i.dsn
