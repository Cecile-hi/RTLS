    ...
    <section id="content" class="border subpage-content">
        ...
        <div class="container_12" id="map">
            ...
            <script>
                ...
                marker.enableDragging();
                var point20 = new BMap.Point(114.065723, 22.657033);
                var myIcon = new BMap.Icon('people.png', new BMap.Size(30, 30));
                var mk = new BMap.Marker(point20, { icon: myIcon });//创建标注图标
